        ...
        @foreach($plans as $plan)
            ...
            <div class="bg-white dark:bg-neutral-900 rounded-2xl overflow-hidden border border-gray-100 dark:border-neutral-800 shadow-sm">
                ...
                <div class="p-5">
                    ...
                    @elseif($isLower)
                        <button disabled class="w-full py-3 px-4 rounded-xl border-2 border-gray-200 dark:border-neutral-700 text-text/40 dark:text-text/40 font-semibold cursor-not-allowed flex items-center justify-center gap-2">
