    ...
    <body class="min-h-screen bg-gray-50/60 text-text dark:bg-neutral-950">
        ...
        <aside class="fixed inset-y-0 left-0 z-50 w-72 hidden lg:flex flex-col border-e border-gray-100 bg-white dark:border-neutral-800 dark:bg-neutral-900">
            ...
            <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
                ...
                <a href="{{ route('dashboard') }}#fund-wallet" class="sidebar-nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all text-text/60 hover:text-text hover:bg-gray-100 dark:hover:bg-white/5" wire:navigate>
                ...
                <a href="{{ route('dashboard') }}#plans" class="sidebar-nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all text-text/60 hover:text-text hover:bg-gray-100 dark:hover:bg-white/5" wire:navigate>
