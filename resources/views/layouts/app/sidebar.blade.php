    ...
    <body class="min-h-screen bg-gray-50/60 text-text dark:bg-neutral-950">
        ...
        <aside class="fixed inset-y-0 left-0 z-50 w-72 hidden lg:flex flex-col border-e border-gray-100 bg-gradient-to-b from-white via-white to-orange-50/60 shadow-[4px_0_24px_rgba(0,0,0,0.04)] dark:border-neutral-800 dark:from-neutral-900 dark:via-neutral-900 dark:to-neutral-950">
            ...
            <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
                ...
                <a href="{{ route('earn.index') }}" class="sidebar-nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('earn.*') ? 'active' : 'text-text/60 hover:text-text hover:bg-gray-100 dark:hover:bg-white/5' }}" wire:navigate>
                ...
                <a href="{{ route('transactions.index') }}" class="sidebar-nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('transactions.*') ? 'active' : 'text-text/60 hover:text-text hover:bg-gray-100 dark:hover:bg-white/5' }}" wire:navigate>
                ...
                <a href="{{ route('affiliate.index') }}" class="sidebar-nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('affiliate.*') ? 'active' : 'text-text/60 hover:text-text hover:bg-gray-100 dark:hover:bg-white/5' }}" wire:navigate>
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m.94 3.198l.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0112 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 016 18.719m12 0a5.971 5.971 0 00-.941-3.197m0 0A5.995 5.995 0 0012 12.75a5.995 5.995 0 00-5.058 2.772m0 0a3 3 0 00-4.681 2.72 8.986 8.986 0 003.74.477m.94-3.197a5.971 5.971 0 00-.94 3.197M15 6.75a3 3 0 11-6 0 3 3 0 016 0zm6 3a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zm-13.5 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z"/></svg>
                    Referrals
                </a>
                <a href="{{ route('affiliate.earners') }}" class="sidebar-nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('affiliate.earners') ? 'active' : 'text-text/60 hover:text-text hover:bg-gray-100 dark:hover:bg-white/5' }}" wire:navigate>
        ...
        <flux:sidebar collapsible="mobile" class="lg:hidden bg-white dark:bg-neutral-900">
            ...
            <flux:sidebar.nav class="space-y-1">
                ...
                <flux:sidebar.group :heading="__('Community')">
                    <flux:sidebar.item icon="user-group" :href="route('affiliate.index')" :current="request()->routeIs('affiliate.*')" wire:navigate>
                        {{ __('Referrals') }}
                    </flux:sidebar.item>
                    <flux:sidebar.item icon="trophy" :href="route('affiliate.earners')" wire:navigate>
                        {{ __('Affiliate Earners') }}
                    </flux:sidebar.item>
                </flux:sidebar.group>
